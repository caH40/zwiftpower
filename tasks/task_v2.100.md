...
-добавление сортировок по столбцам на странице профиля пользователя;  
-выделение максимальных показателей в таблице результатов не на текущей странице, а по всем результатам;  
