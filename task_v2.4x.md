...
---
-добавление данных профиля с zwift при привязке основного zwiftId; 
-обновление профиля User данными из звифита ночью по расписанию, при получении полных результатов Эвента, при ручном запросе обновления профиля из настроек, при привязке основного zwiftId к пофилю;  
