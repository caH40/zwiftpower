 ...
 * 2. Получение данных пользователя на случай, если они изменились со времени создания предыдущего accessToken.
 * 3. Получение данных Организатора, если пользователь является Организатором.
 * 4. Генерация токенов.
 * 5. Возвращение в контроллер нового сгенерированного токена доступа и данных об пользователе.
 */
