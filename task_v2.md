...
2.26.12 +добавление данных Основного профиля Звифт в результаты Эвента, показанные
Дополнительным профилем Звифта;

---

-при привязке чужого zwiftid, которого нет в БД, при переключении на профиль мощности (/me/)
крашится страница;  
