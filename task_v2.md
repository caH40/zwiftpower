...
2.9.3 -исправить верстку там, где использовался SimpleCheckbox (обнулен margin-right, font-size,
font-weight);

---

-переименовать DescriptionEventZwiftNew в семантически правильный вариант;  
