...
графику (chartjs);  
-выбор заезда для сравнения мощностей с 90 дневным;  
-исправить верстку там, где использовался SimpleCheckbox (обнулен margin-right, font-size,
font-weight); -переименовать DescriptionEventZwiftNew в семантически правильный вариант;  
