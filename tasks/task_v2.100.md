...
----
-результаты за этапы распределяются в таблице ГК по порядку, размещать результат за этап в соответствующим столбце;  
-создать класс со статическими методами, возвращающие разные jsx форматы отображения финишного и других времён (выделение тысячных, отображение дисквалификации и т.д.);  
