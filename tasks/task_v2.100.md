...
----
1-при авторизации проверять список клубов в которых пользователь является модератором и если у организатора владеющего данным клубом нет активной подписки, то удалять клуб из списка у пользователя.
