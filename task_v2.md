...
-ссылку из таблицы Догонялок с результата победителя на результаты заезда Догонялок; -добавить
на страницу описание догонялок, картинку; -бот дублирующий сообщения о новых фитчах для группы
zwiftpowerru в тегеграмме;  
