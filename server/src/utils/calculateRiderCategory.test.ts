...
import { TCriticalPowerBestEfforts } from '../types/model.interface.js';
import { TFtpData, TCategoriesWithRange } from '../types/series.types.js';
import { calculateRiderCategory } from './calculateRiderCategory.js';
