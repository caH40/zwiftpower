...
2.103.15 +заменены все options в select выбора конфигурации финишного протокола;  
2.103.16 +скрыто поле выбора серии для привязки добавляемого эвента на сайт;  
...
----
-для серии добавить переменную: отображение/скрытие номеров этапов серии;  
-useChartTypesRace изменить на race,groupride,tt;  
