...
----
-сделать кнопки раскрытия меню более заметными;  
-сделать для пользователя блок сообщений, над лого кружок с количеством непрочинтанных сообщений. Например сообщение о новых заявках в команду;
...
-не сбрасываются изображения после отправки серии заездов (создании), добавить триггер сброса в блок изображения;  
-серия отправляется в завершенные если день окончания совпадает с сегодняшним, изменить, серия завершена, если она завершилась вчера или позже.
