...
export async function mailService(target, token, email, username, password) {
    ...
    <b>Внимание!</b> Ссылка действительна 72 часа. Если Вы не делали данного запроса, то просто проигнорируйте это письмо.<br><br>С уважением, команда ZwiftPower.ru`;
		}
