...
146. +удельные ватты в таблице зарегистрированных райдеров;
147. -бот дублирующий сообщения о новых фитчах для группы zwiftpowerru в тегеграмме;
148. +сохранение фит-файлов заездов каждого райдера в БД;
149. +получение данных райдера с сервера;
150. +ночной запуск обновления fitFiles и powerCurve; запросы в Звифт делать с неосновного
     аккаунта;
151. +при получении результатов заезда сохранять фитфайл в базу данных;
152. +анимация баров. Использование библиотеки styled components;
153. +улучшение отображение гэпов;
154. +отображение принадлежности заезда к серии в таблице расписании/результатах;
