...
----
-FIXME: добавить requiredForGeneral:true во все этапы в сущности NSeries в БД;  
-в таблице главного зачета для результатов которые не попали в лимит отображать соответствующую иконку, вместо кубка на первую тройку;  
-FIXME: в настройки этапа добавить флаг обязательного этапа. Этап необходимо проехать, что бы участвовать в ГК, но его результаты могут и не учитываться в ГК, за это отвечает другой флаг;  
