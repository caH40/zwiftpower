...
-при формировании кривой мощности не все результаты максимальные за период 90 дней; -добавить
состояния загрузки всех новых редюсеров в анимационный компонент Z;  
