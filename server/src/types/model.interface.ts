 ...
 *
 * TODO: Если команды состоят из стандартных команд, не из составов teamSquadAtRace,
 * то необходим контроль/запрет на изменение команды участником в течении серии.
 * Или при смене команды исключение последующих результатов.
 */
export type TSeriesClassification = {
  ...
  stages: TGCRiderStage[]; // Массив этапов, на которых участвовал райдер.
  // stages: {
