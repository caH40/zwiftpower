      ...
      <div className={styles.form} name="zwiftEvent">
        <div className={styles.box__inputs}>
          ...
          <BoxParameter
            ...
            description={
              'Внимание! Для заездов типа Ride автоматически будет выбираться "Не рейтинговый" коэффициент. Если Race и дистанция меньше 7км, тогда автоматически будет выбираться "Спринт" коэффициент!'
            }
          >
            {/* Если отображается идентификатор вместо displayName, значит в  */}
