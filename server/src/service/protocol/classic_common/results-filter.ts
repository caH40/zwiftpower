...
/**
 * Фильтрация и сортировка категорий для Эвента "Классическая без групп" (ClassicCommon)
 ...
 *
 */
export const filterByRankClassicCommon = <T extends ResultEventAdditional | ZwiftResultSchema>(
  results: T[]
): T[] => {
  try {
